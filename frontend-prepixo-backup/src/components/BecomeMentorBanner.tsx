    ...
    <section className="px-3 sm:px-4 py-8 sm:py-12 mb-8">
      <div className="container mx-auto">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-600/20 via-red-600/10 to-orange-600/20 border border-red-500/30 p-6 sm:p-10"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 bg-gradient-to-r from-red-400 via-red-400 to-orange-400 bg-clip-text text-transparent">
                Become a Mentor
              </h2>
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 mb-6">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500/20 to-red-500/20 flex items-center justify-center">
