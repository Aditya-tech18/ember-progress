  ...
  public: {
    Tables: {
      admin_application_chats: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_application_chats_application_id_fkey"
      ...
      mentor_applications: {
        Row: {
          ...
          course: string
          created_at: string | null
          display_college_publicly: boolean | null
          email: string
      ...
      mentor_chats: {
        ...
        Relationships: [
          {
            foreignKeyName: "mentor_chats_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      mentor_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "mentor_sessions_service_id_fkey"
            columns: ["service_id"]
            isOneToOne: false
