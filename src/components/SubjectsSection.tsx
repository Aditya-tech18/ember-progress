          ...
          {subjects.map((subject, index) => (
            ...
            >
              <div className="glass-card rounded-2xl p-6 hover-lift h-full flex flex-col">
                {/* Icon */}
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${subject.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="mt-auto">
                  <Button className={`w-full bg-gradient-to-r ${subject.color} text-foreground hover:opacity-90 font-semibold group`}>
                    Continue Learning
