...
import NeetMockTestInstructions from "./neet/NeetMockTestInstructions";
const MockTestInstructionsRouter = () => (getCachedGoal() === "NEET" ? <NeetMockTestInstructions /> : <MockTestInstructions />);
export default MockTestInstructionsRouter;
