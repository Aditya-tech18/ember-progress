          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto mb-8">
              {benefits.map((benefit, idx) => (
                <Card key={idx} className="p-4 border-red-500/30">
                  <benefit.icon className="w-8 h-8 text-red-400 mx-auto mb-2" />
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="space-y-8">
            {selectionSteps.map((step, idx) => (
              ...
              >
                <Card className="p-6 hover:border-red-500/50 transition-all">
          ...
          <div className="text-center mt-12">
            <Button
              ...
              className="bg-gradient-to-r from-red-600 via-red-600 to-red-600 hover:from-red-500 hover:via-red-500 hover:to-red-500 text-white font-bold text-lg px-12 py-6 shadow-2xl hover:shadow-red-500/50 transition-all group"
            >
              Apply Now
