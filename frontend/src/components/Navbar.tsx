      ...
      >
        <div className="container mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-[68px]">
            ...
            <div className="relative goal-menu-container flex items-center gap-2 sm:gap-3 min-w-0">
              <motion.div
              ...
              >
                <img 
                  ...
                  alt="Prepixo" 
                  className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl shadow-md shadow-primary/20 object-cover"
                />
                <span className="text-base sm:text-lg font-bold text-foreground hidden md:block tracking-tight">
                  Prepixo
                </span>
              </motion.div>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-[#25D366] hover:bg-[#25D366]/90 text-white rounded-xl text-xs font-semibold shadow-md shadow-[#25D366]/20 transition-all shrink-0"
              >
            ...
            <div className="hidden xl:flex items-center gap-2">
              <motion.button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600/15 border border-emerald-500/30 rounded-xl text-emerald-400 text-xs font-semibold hover:bg-emerald-600/25 transition-all"
              >
                See Plans
              </motion.button>
              ...
              <motion.button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-500/15 border border-amber-500/30 rounded-xl text-amber-400 text-xs font-semibold hover:bg-amber-500/25 transition-all"
              >
                🏆 Leaderboard
              </motion.button>
            </div>
