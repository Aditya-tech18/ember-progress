...
const BANNERS = [
  {
    ...
    description: "Achieve a 1500+ question streak and get your PYQBook subscription fee fully refunded.",
  ...
  },
  {
    ...
    subtitle: "Work & Earn with PYQBook",
    description: "Add 20+ students to the PYQBook WhatsApp community and get a chance to work with our team.",
